      ...
      <div className="glass p-2">
        <div className="aspect-square rounded-xl overflow-hidden relative mb-3">
          {imageUrl ? (
            ...
            <div className="w-full h-full flex items-center justify-center text-text-tertiary bg-white/10">
        ...
        <div className="px-1 pb-1">
          ...
          <p className="text-xs text-text-secondary truncate font-mono font-light">{artist}</p>
        </div>
      </div>
    </Link>
  );
